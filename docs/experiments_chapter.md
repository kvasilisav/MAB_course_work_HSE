...
**Методология OPE.** Использован SNIPS replay с замороженной candidate-политикой, не DR [27]; batch E3/E8 — приложение А. Контекст в OBD строится MD5-хэшированием признаков в `scripts/prepare_open_bandit.py` — это не полноценная contextual OPE для LinUCB на random-логах. LinUCB не оценивался в streaming E9 на full OBD (P1).
